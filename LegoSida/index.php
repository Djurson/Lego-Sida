...
<body>
    ...
    <div class="main">
        <div class="header-text">
            <h2>SÖK EFTER LEGO SET<h2>
        </div>
        <div class="search-div">
            <!-- Endast ett formulär där användaren kan skriva in vad den vill söka efter -->
            <form action="<?php echo htmlspecialchars('php/searchresult.php'); ?>" method="GET">
            ...
            <div class="legomanspeech">
                <div id="speechbubble" class="hide">
                    <p class="speechbubble">Sök efter något!</p>
                </div>
